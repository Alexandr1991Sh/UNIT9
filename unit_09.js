...
function f18() {
    let atribut = document.querySelector('.p-18').getAttribute('data-b');
    document.querySelector('.out-18').innerHTML = atribut;
}
...
function f19() {
    let atribut = document.querySelectorAll('.p-19');
    for (let i = 0; i <= atribut.length; i++) {
        let data = atribut[i].getAttribute('data-b')
